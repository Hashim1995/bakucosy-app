  ...
  return (
    <>
      ...
      >
        ...
        >
          <ReCAPTCHA
            sitekey="6LdHOYweAAAAANFEYRSlHG-D_ROiGKcCPqL1AS2J"
      ...
      >
        <div>
          ...
          <p>Welcome to www.bakucosyshop.com!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Baku Cosy Shop's Website, located at www.bakucosyshop.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use www.bakucosyshop.com if you do
          ...
          <p>
            We employ the use of cookies. By accessing www.bakucosyshop.com, you
            agreed to use cookies in agreement with the Baku Cosy Shop's Privacy
            Policy.{" "}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Baku Cosy Shop and/or its licensors own the
            intellectual property rights for all material on
            www.bakucosyshop.com. All intellectual property rights are reserved.
            You may access this from www.bakucosyshop.com for your own personal
            use subjected to restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from www.bakucosyshop.com</li>
            <li>
              Sell, rent or sub-license material from www.bakucosyshop.com
            </li>
            <li>
              Reproduce, duplicate or copy material from www.bakucosyshop.com
            </li>
            <li>Redistribute content from www.bakucosyshop.com</li>
          </ul>
          <p>
          ...
          <p>
            ...
            Baku Cosy Shop does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Baku Cosy Shop,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their
            views and opinions. To the extent permitted by applicable laws, Baku
            Cosy Shop shall not be liable for the Comments or for any liability,
          ...
          <p>
            Baku Cosy Shop reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Baku Cosy Shop a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Baku Cosy
            Shop; and (d) the link is in the context of general resource
            information.
          </p>
          <p>
          ...
          <p>
            ...
            sending an e-mail to Baku Cosy Shop. Please include your name, your
          ...
          <p>
            No use of Baku Cosy Shop's logo or other artwork will be allowed for
